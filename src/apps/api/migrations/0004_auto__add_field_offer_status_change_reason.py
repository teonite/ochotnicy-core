...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.status_change_reason'
        db.add_column(u'api_offer', 'status_change_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.status_change_reason'
        db.delete_column(u'api_offer', 'status_change_reason')
