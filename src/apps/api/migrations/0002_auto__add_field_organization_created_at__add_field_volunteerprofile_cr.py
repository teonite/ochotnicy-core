...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_organization', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now(), auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VolunteerProfile.created_at'
        db.add_column(u'api_volunteerprofile', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now(), auto_now_add=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_organization', 'created_at')

        # Deleting field 'VolunteerProfile.created_at'
        db.delete_column(u'api_volunteerprofile', 'created_at')
    ...
    models = {
        ...
        u'api.offer': {
            ...
            'publish_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'publish_to': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
